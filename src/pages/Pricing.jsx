  ...
  return (
    <div id="pricing">
      ...
      <div className="md:flex justify-center items-center gap-12 ">
        {/* Starter - Container*/}
        <div className="border-[.5px] border-secondaryBackground rounded-xl flex flex-col justify-center items-center xs:w-[80vw] md:w-[350px] mx-auto p-[3rem] mb-[4rem]">
        ...
        {/* Complete - Container*/}
        <div className="border-[.5px] border-secondaryBackground bg-primaryBackground rounded-xl flex flex-col justify-center items-center xs:w-[80vw] md:w-[350px] mx-auto p-[3rem] mb-[4rem] relative overflow-hidden">
