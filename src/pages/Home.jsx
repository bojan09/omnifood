  ...
  return (
    ...
    >
      <div className="md:flex flex-col gap-6 xs:pt-5 md:flex-1">
        ...
        {/* Buttons */}
        <div className="flex justify-center items-center xs:gap-2 md:gap-4 py-4 xs:py-[3rem] md:ml-5">
          <button>
            <a
              className="bg-primaryColor hover:bg-shadeColor transition-all duration-500 ease-in-out text-white py-3 px-[6px] rounded-lg text-lg font-medium"
              href="#contact"
            >
          ...
          <button>
            <a
              className="bg-white  hover:text-primaryColor transition-all duration-500 ease-in-out py-3 px-[6px] rounded-lg font-medium text-lg"
              href="#howItWorks"
            >
              Learn more ↓
            </a>
